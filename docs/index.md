...
- [Decision record 0001](decisions/0001-authoritative-action-boundary.md), [decision record 0002](decisions/0002-additive-d1-and-target-safety.md), [decision record 0003](decisions/0003-open-product-decisions.md), and [decision record 0004](decisions/0004-economy-v1.md) contain accepted decisions and open product questions.
