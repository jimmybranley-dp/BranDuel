...
| `src/engine.ts`                             | Odds, betting restrictions, records, ratings, display formatting                                         | Accepting external writes                                 |
...
| `src/frontend/ratings.tsx`                  | Game-specific ratings presentation                                                                       | Rating calculation                                        |
